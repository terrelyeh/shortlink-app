...
const PRODUCT_LAUNCH: Playbook = {
  ...
  channels: [
    ...
    {
      id: "edm_v2",
      label: "EDM #2 — Follow-up",
      utmSource: "newsletter",
      utmMedium: "email",
      utmContent: "followup",
      hint: "Second piece — reminder / case study / FAQ",
    },
    {
      id: "fb_v1",
      label: "Facebook post — Announcement",
      utmSource: "facebook",
      utmMedium: "social",
      utmContent: "announce",
    },
    {
      id: "fb_v2",
      label: "Facebook post — Follow-up",
      utmSource: "facebook",
      utmMedium: "social",
      utmContent: "followup",
      hint: "Second piece / follow-up post",
    },
    {
      id: "li_v1",
      label: "LinkedIn post — Announcement",
      utmSource: "linkedin",
      utmMedium: "social",
      utmContent: "announce",
    },
